...
function N(e, t, n, i) { let s; const r = arguments.length; let a = r < 3 ? t : i === null ? i = Object.getOwnPropertyDescriptor(t, n) : i; if (typeof Reflect === 'object' && typeof Reflect.decorate === 'function')a = Reflect.decorate(e, t, n, i); else for (let o = e.length - 1; o >= 0; o--)(s = e[o]) && (a = (r < 3 ? s(a) : r > 3 ? s(t, n, a) : s(t, n)) || a); return r > 3 && a && Object.defineProperty(t, n, a), a; } const D = Object.freeze({
  ...
  pattern: D.PATTERN_MISMATCH, minLength: D.TOO_SHORT, maxLength: D.TOO_LONG, maximum: D.RANGE_OVERFLOW, minimum: D.RANGE_UNDERFLOW, type: D.TYPE_MISMATCH, required: D.VALUE_MISSING, step: D.STEP_MISMATCH, format: D.FORMAT_MISMATCH, accept: D.ACCEPT_MISMATCH, maxFileSize: D.FILE_SIZE_MISMATCH, uniqueItems: D.UNIQUE_ITEMS_MISMATCH, minItems: D.MIN_ITEMS_MISMATCH, maxItems: D.MAX_ITEMS_MISMATCH, validationExpression: D.EXPRESSION_MISMATCH, exclusiveMinimum: D.EXCLUSIVE_MINIMUM_MISMATCH, exclusiveMaximum: D.EXCLUSIVE_MAXIMUM_MISMATCH,
}); const S = Object.freeze({
  [D.PATTERN_MISMATCH]: 'Please match the format requested.', [D.TOO_SHORT]: 'Please lengthen this text to ${0} characters or more.', [D.TOO_LONG]: 'Please shorten this text to ${0} characters or less.', [D.RANGE_OVERFLOW]: 'Value must be less than or equal to ${0}.', [D.RANGE_UNDERFLOW]: 'Value must be greater than or equal to ${0}.', [D.TYPE_MISMATCH]: 'Please enter a valid value.', [D.VALUE_MISSING]: 'Please fill in this field.', [D.STEP_MISMATCH]: 'Please enter a valid value.', [D.FORMAT_MISMATCH]: 'Specify the value in allowed format : ${0}.', [D.ACCEPT_MISMATCH]: 'The specified file type not supported.', [D.FILE_SIZE_MISMATCH]: 'File too large. Reduce size and try again.', [D.UNIQUE_ITEMS_MISMATCH]: 'All the items must be unique.', [D.MIN_ITEMS_MISMATCH]: 'Specify a number of items equal to or greater than ${0}.', [D.MAX_ITEMS_MISMATCH]: 'Specify a number of items equal to or less than ${0}.', [D.EXPRESSION_MISMATCH]: 'Please enter a valid value.', [D.EXCLUSIVE_MINIMUM_MISMATCH]: 'Value must be greater than ${0}.', [D.EXCLUSIVE_MAXIMUM_MISMATCH]: 'Value must be less than ${0}.',
}); const C = {}; let F; let A; let k; !(function (e) { e.CODE = 'code', e.UI = 'ui'; }(F || (F = {}))); class R {
  fieldName;

  errorMessages;

  constructor(e = '', t = []) { this.errorMessages = t, this.fieldName = e; }
}!(function (e) { e.NEXT_ITEM = 'nextItem', e.PREVIOUS_ITEM = 'previousItem'; }(A || (A = {}))), (function (e) { e.INVISIBLE = 'invisible', e.VISIBLE = 'visible'; }(k || (k = {}))); const P = (e) => new Map(Object.entries(e)); const V = P({ date: 'date-input', 'data-url': 'file-input', binary: 'file-input' }); const q = P({
  number: 'number-input', boolean: 'checkbox', object: 'panel', array: 'panel', file: 'file-input', 'file[]': 'file-input',
}); const U = ['string[]', 'boolean[]', 'number[]', 'array']; const z = (e) => { const t = e.type || 'string'; if ('enum' in e) { return e.enum.length > 2 || U.indexOf(t) > -1 ? 'drop-down' : 'checkbox'; } return t === 'string' || t === 'string[]' ? V.get(e.format) || 'text-input' : q.get(t) || 'text-input'; }; const L = function (e) { return e?.type === 'file' || e?.type === 'file[]' || (e?.type === 'string' || e?.type === 'string[]') && (e?.format === 'binary' || e?.format === 'data-url'); }; function H(e, t) { if (e === null || typeof e !== 'object') return e; let n; if (Array.isArray(e)) { n = new Array(e.length); for (let i = 0; i < e.length; i++)n[i] = H(e[i], t); } else { n = {}; for (const i of Object.keys(e))n[i] = H(e[i], t); } return t && n && n.id && (n.id = t()), n; } const Q = (e) => JSON.stringify(e, null, 2); const G = (e) => e.repeatable && (void 0 === e.minOccur && void 0 === e.maxOccur || void 0 !== e.minOccur && void 0 !== e.maxOccur && e.maxOccur !== 0 || void 0 !== e.minOccur && void 0 !== e.maxOccur && e.minOccur !== 0 && e.maxOccur !== 0 || void 0 !== e.minOccur && e.minOccur >= 0 || void 0 !== e.maxOccur && e.maxOccur !== 0) || !1; class B {
  $_name;
...
} const X = Symbol('NullValue'); const W = new class extends B {
  constructor() { super('', X, 'null'); }
  ...
  createEntry(e, t, n) { const i = Array.isArray(t) ? 'array' : typeof t; return typeof t === 'object' && t != null ? new J(e, t, i, n) : new B(e, t, i, n); }
  ...
  $convertToDataValue() { return new B(this.$name, this.$value, this.$type, this.parent); }

  syncDataAndFormModel(e) { this.$_fields.forEach(((t) => { e && e !== t && t.syncDataAndFormModel(this); })); }

  $addDataNode(e, t, n = !1, i = null) { if (t !== W) { if (this.$type === 'array') { const s = e; n ? this.$_items[e] = t : this.$_items.splice(s, 0, t), this.syncDataAndFormModel(i); } else this.$_items[e] = t; t.parent = this; } }
...
} const K = 'Identifier'; const Z = 'Global'; const Y = 'Repeatable'; const ee = 'bracket'; const te = (e, t) => ({ type: K, value: e, start: t }); const ne = function (e) { return e >= 'a' && e <= 'z' || e >= 'A' && e <= 'Z' || e >= '0' && e <= '9' || e === '_'; }; const ie = (e, t, n) => e === null && t[n] === '$'; const se = (e, t, n) => e === null && t[n] === '#'; const re = (e, t) => { const n = e[t]; return n === '$' ? e.length > t && ne(e[t + 1]) : n >= 'a' && n <= 'z' || n >= 'A' && n <= 'Z' || n === '_'; }; const ae = (e) => e >= '0' && e <= '9'; class oe {
  stream;
  ...
  _consumeGlobal() { return this._current += 1, { type: Z, start: 0, value: '$' }; }

  _consumeRepeatable() { return this._current += 1, { type: Y, start: 0, value: '#' }; }

  _consumeUnquotedIdentifier(e) { const t = this._current; for (this._current += 1; this._current < e.length && ne(e[this._current]);) this._current += 1; return te(e.slice(t, this._current), t); }

  _consumeQuotedIdentifier(e) { const t = this._current; this._current += 1; const n = e.length; for (;e[this._current] !== '"' && this._current < n;) { let t = this._current; e[t] !== '\\' || e[t + 1] !== '\\' && e[t + 1] !== '"' ? t += 1 : t += 2, this._current = t; } return this._current += 1, te(JSON.parse(e.slice(t, this._current)), t); }

  _consumeNumber(e) { const t = this._current; this._current += 1; const n = e.length; for (;ae(e[this._current]) && this._current < n;) this._current += 1; const i = e.slice(t, this._current); return { type: 'Number', value: parseInt(i, 10), start: t }; }

  _consumeBracket(e) { const t = this._current; let n; if (this._current += 1, !ae(e[this._current])) throw new Error(`unexpected exception at position ${this._current}. Must be a character`); if (n = this._consumeNumber(e).value, this._current < this.stream.length && e[this._current] !== ']') throw new Error(`unexpected exception at position ${this._current}. Must be a character`); return this._current++, ((e, t) => ({ type: ee, value: e, start: t }))(n, t); }

  tokenize() { const e = this.stream; for (;this._current < e.length;) { const t = this._tokens.length ? this._tokens.slice(-1)[0] : null; if (ie(t, e, this._current)) { const e = this._consumeGlobal(); this._tokens.push(e), this._result_tokens.push(e); } else if (se(t, e, this._current)) { const e = this._consumeRepeatable(); this._tokens.push(e), this._result_tokens.push(e); } else if (re(e, this._current)) { const t = this._consumeUnquotedIdentifier(e); this._tokens.push(t), this._result_tokens.push(t); } else if (e[this._current] === '.' && t != null && t.type !== 'DOT') this._tokens.push({ type: 'DOT', value: '.', start: this._current }), this._current += 1; else if (e[this._current] === '[') { const t = this._consumeBracket(e); this._tokens.push(t), this._result_tokens.push(t); } else { if (e[this._current] !== '"') { const e = Math.max(0, this._current - 2); const t = Math.min(this.stream.length, this._current + 2); throw new Error(`Exception at parsing stream ${this.stream.slice(e, t)}`); } { const t = this._consumeQuotedIdentifier(e); this._tokens.push(t), this._result_tokens.push(t); } } } return this._result_tokens; }
} const le = (e) => new oe(e).tokenize(); const ue = (e, t, n) => { let i; i = typeof t === 'string' ? le(t) : t; let s = e; let r = 0; const a = (e, t, n) => (t === null ? n : t.type === ee ? new J(e.value, [], 'array') : new J(e.value, {})); for (;r < i.length && s != null;) { const t = i[r]; if (t.type === Z)s = e; else if (t.type === K) { if (!(s instanceof J && s.$type === 'object')) throw new Error(`Looking for ${t.value} in ${s.$value}`); if (s.$containsDataNode(t.value) && s.$getDataNode(t.value).$value !== null)s = s.$getDataNode(t.value); else if (n) { const e = a(t, r < i.length - 1 ? i[r + 1] : null, n); s.$addDataNode(t.value, e), s = e; } else s = void 0; } else if (t.type === ee) { if (!(s instanceof J && s.$type === 'array')) throw new Error(`Looking for index ${t.value} in non array${s.$value}`); { const e = t.value; if (e < s.$length)s = s.$getDataNode(e); else if (n) { const o = a(t, r < i.length - 1 ? i[r + 1] : null, n); s.$addDataNode(e, o), s = o; } else s = void 0; } }r += 1; } return s; }; class de {
  data;
...
} const he = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_'.split(''); const ce = /^(\d*\.?\d+)(\\?(?=[KMGT])([KMGT])(?:i?B)?|B?)$/i; const pe = (e) => { const t = []; for (let n = 0; n <= e; n++) { let e; e = n === 0 ? Math.floor(Math.random() * (he.length - 11)) : Math.floor(Math.random() * he.length), t.push(he[e]); } return t.join(''); }; const me = (e, t = !1) => { const n = e.items || []; return n?.reduce(((e, n) => { if (t && n.dataRef === null) return e; let i = null; if (n.isContainer)i = me(n, t); else if (L(n.getState())) { i = {}; const e = n.name || ''; const t = n.dataRef != null ? n.dataRef : e.length > 0 ? n.name : void 0; n.value instanceof Array ? i[n.id] = n.value.map(((e) => ({ ...e, dataRef: t }))) : n.value != null && (i[n.id] = { ...n.value, dataRef: t }); } return Object.assign(e, i); }), {}); }; const fe = (e) => { let t = 0; if (typeof e === 'string') { const n = ce.exec(e.trim()); n != null && (t = ge(parseFloat(n[1]), (n[2] || 'kb').toUpperCase())); } return t; }; const ge = (e, t) => {
  const n = 1024 ** {
    KB: 1, MB: 2, GB: 3, TB: 4,
  }[t]; return Math.round(e * n);
}; const _e = (e) => /^data:([a-z]+\/[a-z0-9-+.]+)?;(?:name=(.*);)?base64,(.*)$/.exec(e.trim()) != null; const ye = (e) => { const t = /^data:([a-z]+\/[a-z0-9-+.]+)?(?:;name=([^;]+))?(;base64)?,(.+)$/.exec(e); if (t !== null) { const e = t[1] || ''; const n = t[2] || 'unknown'; if (typeof t[3] === 'string') { const i = atob(t[4]); const s = []; for (let e = 0; e < i.length; e++)s.push(i.charCodeAt(e)); return { name: n, blob: new window.Blob([new Uint8Array(s)], { type: e }) }; } return { name: n, blob: new window.Blob([t[4]], { type: e }) }; } return null; }; const ve = (e) => { if (!e || !Object.keys(e).length) return e; if ((':items' in (t = e) || 'cqItems' in t) && (':itemsOrder' in t || 'cqItemsOrder' in t)) { const t = []; const n = e[':itemsOrder'] || e.cqItemsOrder; const i = e[':items'] || e.cqItems; n.forEach(((e) => { t.push(ve(i[e])); })), e.items = t; } let t; return e; }; const Me = /^(\d{4})-(\d{1,2})-(\d{1,2})$/; const be = /^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/; const je = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]; const Ee = (e) => { if (e === '' || e == null) return { value: '', valid: !0 }; let t = parseFloat(e); const n = !isNaN(t); return n || (t = e), { value: t, valid: n }; }; const xe = (e) => { if (e === '' || e == null) return { value: '', valid: !0 }; let t = parseFloat(e); const n = !isNaN(t) && Math.round(t) === t; return n || (t = e), { value: t, valid: n }; }; const Ie = (e) => (e == null || e instanceof Array ? e : [e]); const Te = (e) => { const t = typeof e === 'boolean' || e === 'true' || e === 'false'; return { valid: t, value: typeof e === 'boolean' ? e : t ? e === 'true' : e }; }; const we = (e) => {
  const t = ((e) => {
    if (e !== null) {
      let t = null; if (e instanceof de)t = e; else if (typeof File !== 'undefined' && e instanceof File) {
        t = {
          name: e.name, mediaType: e.type, size: e.size, data: e,
        };
      } else if (typeof e === 'string' && _e(e)) {
        const n = ye(e); if (n !== null) {
          const { blob: e, name: i } = n; t = {
            name: i, mediaType: e.type, size: e.size, data: e,
          };
        }
      } else {
        let n = e; try { n = JSON.parse(e), t = n, t.mediaType || (t.mediaType = t.type); } catch (e) {} if (typeof n?.data === 'string' && _e(n?.data)) {
          const e = ye(n?.data); if (e !== null) {
            const i = e.blob; t = {
      ...
      } return t !== null && t.data != null ? new de(t) : null;
    } return null;
  })(e); const n = t !== null; return { value: n ? t : e, valid: n };
}; const $e = (e, t) => { const n = Ie(e); return n == null ? [[], [n]] : n.reduce(((e, n) => { if (e[1].length == 0) { const i = t(n); e[i.valid ? 0 : 1].push(i.value); } return e; }), [[], []]); }; const Ne = {
...
}; const De = ['type', 'format', 'minimum', 'maximum', 'exclusiveMinimum', 'exclusiveMaximum', 'minItems', 'maxItems', 'uniqueItems', 'minLength', 'maxLength', 'pattern', 'required', 'enum', 'accept', 'maxFileSize']; const Oe = {
  type: (e, t) => { let n = t; if (t == null) return { valid: !0, value: t }; let i; let s = !0; switch (e) { case 'string': s = !0, n = t.toString(); break; case 'string[]': n = Ie(t); break; case 'number': i = Ee(t), n = i.value, s = i.valid; break; case 'boolean': i = Te(t), s = i.valid, n = i.value; break; case 'integer': i = xe(t), s = i.valid, n = i.value; break; case 'integer[]': i = $e(t, xe), s = i[1].length === 0, n = s ? i[0] : t; break; case 'file': i = we(t instanceof Array ? t[0] : t), s = i.valid, n = i.value; break; case 'file[]': i = $e(t, we), s = i[1].length === 0, n = s ? i[0] : t; break; case 'number[]': i = $e(t, Ee), s = i[1].length === 0, n = s ? i[0] : t; break; case 'boolean[]': i = $e(t, Te), s = i[1].length === 0, n = s ? i[0] : t; } return { valid: s, value: n }; }, format: (e, t) => { let n = !0; const i = t; if (t === null) return { value: i, valid: n }; let s; switch (e) { case 'date': if (s = Me.exec((t || '').trim()), s != null) { const [e, t, i, r] = s; const [a, o] = [+i, +r]; const l = ((e) => e % 400 == 0 || e % 4 == 0 && e % 100 != 0)(+t); n = a >= 1 && a <= 12 && o >= 1 && o <= ((e, t) => (e && t == 2 ? 29 : je[t - 1]))(l, a); } else n = !1; break; case 'email': n = new RegExp(be).test((t || '').trim()); break; case 'data-url': n = !0; } return { valid: n, value: i }; }, minimum: (e, t) => ({ valid: t >= e, value: t }), maximum: (e, t) => ({ valid: t <= e, value: t }), exclusiveMinimum: (e, t) => ({ valid: t > e, value: t }), exclusiveMaximum: (e, t) => ({ valid: t < e, value: t }), minItems: (e, t) => ({ valid: t instanceof Array && t.length >= e, value: t }), maxItems: (e, t) => ({ valid: t instanceof Array && t.length <= e, value: t }), uniqueItems: (e, t) => ({ valid: !e || t instanceof Array && t.length === new Set(t).size, value: t }), minLength: (e, t) => ({ ...Oe.minimum(e, typeof t === 'string' ? t.length : 0), value: t }), maxLength: (e, t) => ({ ...Oe.maximum(e, typeof t === 'string' ? t.length : 0), value: t }), pattern: (e, t) => { let n; return n = typeof e === 'string' ? new RegExp(e) : e, { valid: n.test(t), value: t }; }, required: (e, t) => ({ valid: !e || t != null && t !== '', value: t }), enum: (e, t) => ({ valid: e.indexOf(t) > -1, value: t }), accept: (e, t) => { if (!e || e.length === 0 || t == null) return { valid: !0, value: t }; return { valid: !(t instanceof Array ? t : [t]).some(((t) => { return n = t.type, i = e, !(!n || i.some(((e) => { const t = e.trim(); const i = t.split('/')[0]; const s = t.split('.')[1]; return t.includes('*') && n.startsWith(i) || t.includes('.') && n.endsWith(s) || t === n; }))); let n; let i; })), value: t }; }, maxFileSize: (e, t) => { const n = typeof e === 'string' ? fe(e) : e; return { valid: !(t instanceof de) || t.size <= n, value: t }; },
}; const Se = ['value', 'label', 'description', 'visible', 'enabled', 'valid', 'errorMessage', 'readOnly', 'enum', 'enumNames', 'required', 'properties', 'exclusiveMinimum', 'exclusiveMaximum', 'maximum', 'maxItems', 'minimum', 'minItems', 'checked']; const Ce = [...Se, 'index', 'activeChild']; const Fe = ['plain-text', 'image']; class Ae {
  _action;
...
} const ke = Symbol('target'); const Re = Symbol('qualifiedName'); const Pe = (e) => (...t) => (n, i, s) => { const r = s.get; r != null && (s.get = function () { if (t.indexOf(this.fieldType) > -1 === e) return r.call(this); }); const a = s.set; a != null && (s.set = function (n) { t.indexOf(this.fieldType) > -1 === e && a.call(this, n); }); }; const Ve = Pe(!0); const qe = Pe(!1); class Ue {
  _options;
  ...
  constructor(e, t) { this._options = t, this[Re] = null, this._jsonModel = { ...e, id: 'id' in e ? e.id : this.form.getUniqueId() }, this.parent?.isFragment ? this._fragment = this.parent.qualifiedName : this.parent?.fragment && (this._fragment = this.parent.fragment); }
  ...
  getFromRule(e, t) { if (t === Symbol.toPrimitive || t === 'valueOf' && !e.hasOwnProperty('valueOf')) return this.valueOf; if (t === ke) return this; if (typeof t === 'string') if (t.startsWith('$')) { if (typeof this[t = t.substr(1)] !== 'function') { const e = this[t]; return e instanceof Ue ? e.getRuleNode() : e instanceof Array ? e.map(((e) => (e instanceof Ue ? e.getRuleNode() : e))) : e; } } else { if (e.hasOwnProperty(t)) return e[t]; if (typeof e[t] === 'function') return e[t]; } }
  ...
  _addDependent(e) { if (void 0 === this._dependents.find((({ node: t }) => t === e))) { const n = this.subscribe(((n) => { const i = n.payload.changes; const s = [...Ce, 'items']; i.findIndex(((e) => s.indexOf(e.propertyName) > -1)) > -1 && (this.form.changeEventBehaviour === 'deps' ? e.dispatch(n) : e.dispatch(new t())); })); this._dependents.push({ node: e, subscription: n }); } }
  ...
  queueEvent(e) { const t = new Ae(e, this); this.form.getEventQueue().queue(this, t, ['valid', 'invalid'].indexOf(t.type) > -1); }

  dispatch(e) { this.queueEvent(e), this.form.getEventQueue().runPendingQueue(); }

  notifyDependents(e) { const t = this._jsonModel._dependents; t && (t.forEach(((e) => { const t = this.form.getElement(e); t && this._addDependent(t); })), this._jsonModel._dependents = void 0); (this._callbacks[e.type] || []).forEach(((t) => { t(new Ae(e, this)); })); }

  isEmpty(e = this._jsonModel.value) { return e == null || e === ''; }

  _setProperty(t, n, i = !0, s = ((e) => {})) { const r = this._jsonModel[t]; let a = !1; if (a = n !== null && r !== null && typeof n === 'object' && typeof r === 'object' ? JSON.stringify(n) === JSON.stringify(r) : r === n, !a) { this._jsonModel[t] = n; const a = e(t, n, r); return i && this.notifyDependents(a), s.call(this, a), De.includes(t) && this.validate(), a.payload.changes; } return []; }

  bindToDataModel(e) { if (this.fieldType === 'form' || this.id === '$form') return void (this._data = e); const t = this._jsonModel.dataRef; let n; let i = e; let s = ''; if (t === null)n = W; else if (void 0 === t || this.repeatable) { if (e !== W && Fe.indexOf(this.fieldType) === -1) { i = e; const t = this._jsonModel.name || ''; const r = e.$type === 'array' ? this.index : t; if (s = r, r !== '') { const t = this.defaultDataModel(r); void 0 !== t && (n = e.$getDataNode(r), void 0 === n && (n = t, e.$addDataNode(r, n))); } else n = void 0; } } else { this._tokens.length === 0 && (this._tokens = le(t)); let r = e; if (this._tokens[0].type === Z)r = this.form.getDataNode(); else if (this._tokens[0].type === Y) { let e = this.parent; for (;!e.repeatable && e !== this.form;)e = e.parent; r = e.getDataNode(); } if (void 0 !== r) { const e = this._tokens[this._tokens.length - 1].value; const t = this.defaultDataModel(e); n = ue(r, this._tokens, t), i = ue(r, this._tokens.slice(0, -1)), s = e; } } return n && (this.isContainer || i === W || n === W || (n = n?.$convertToDataValue(), i.$addDataNode(s, n, !0)), n?.$bindToField(this), this._data = n), this._data; }
  ...
  get qualifiedName() { if (this.isTransparent()) return null; if (this[Re] !== null) return this[Re]; const e = this.getNonTransparentParent(); return e && e.type === 'array' ? this[Re] = `${e.qualifiedName}[${this.index}]` : this[Re] = `${e.qualifiedName}.${this.name}`, this[Re]; }
...
}N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], Ue.prototype, 'index', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], Ue.prototype, 'description', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], Ue.prototype, 'visible', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], Ue.prototype, 'label', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], Ue.prototype, 'properties', null); class ze extends Ue {
  _events = {};
  ...
  applyUpdates(e) { typeof e === 'object' ? e !== null && Object.entries(e).forEach((([e, t]) => { if (e in Se || e in this && typeof this[e] !== 'function') try { this[e] = t; } catch (e) { console.error(e); } })) : void 0 !== e && (this.value = e); }

  executeAllRules(e) { const t = Object.entries(this.getRules()); if (t.length > 0) { const n = this.getExpressionScope(); t.forEach((([t, i]) => { const s = this.getCompiledRule(t, i); if (s) { const r = this.ruleEngine.execute(s, n, e, !0, i); if (Se.indexOf(t) > -1) { this.isEmpty() && this.isEmpty(r) && t === 'value' || (this[t] = r); } else this.form.logger.warn(`${t} is not a valid editable property.`); } })); } }

  getExpressionScope() { const e = this.getNonTransparentParent(); const t = { self: this.getRuleNode(), siblings: e?.ruleNodeReference() || {} }; const n = new Proxy(t, { get: (e, t) => { if (t === Symbol.toStringTag) return 'Object'; if (typeof t === 'string' && t.startsWith('$')) { const n = e.self[t]; return n instanceof Ue ? n.getRuleNode() : n instanceof Array ? n.map(((e) => (e instanceof Ue ? e.getRuleNode() : e))) : n; } return t in e.siblings ? e.siblings[t] : e.self[t]; }, has: (e, t) => { const n = e.self[t]; const i = e.siblings[t]; return void 0 !== n || void 0 !== i; } }); return n; }

  executeEvent(e, t, n) { let i; t && (i = this.ruleEngine.execute(t, this.getExpressionScope(), e, !1, n)), void 0 !== i && i != null && this.applyUpdates(i); }
...
} const Le = ['readOnly', 'enabled']; class He extends ze {
  _children = [];
  ...
  getItemsState(e = !1, t = !1) { return this._jsonModel.type === 'array' || G(this._jsonModel) || e ? e ? this._getFormAndSitesState(e, t) : this._children.map(((e) => ({ ...e.getState(!0, t) }))) : this._getFormAndSitesState(e, t); }
  ...
  _addChild(e, t, n = !1, i = 'create') { let s = this; for (;s != null && s.isTransparent();)s = s.parent; (typeof t !== 'number' || t > s._children.length) && (t = this._children.length); const r = this.form; const a = { index: t, ...H(e, n ? () => r.getUniqueId() : void 0) }; const o = this._createChild(a, { parent: this, form: this.form, mode: i }); return e.id = o.id, this.form.fieldAdded(o), this._addChildToRuleNode(o, { parent: s }), t === this._children.length ? this._children.push(o) : this._children.splice(t, 0, o), o; }

  indexOf(e) { return this._children.indexOf(e); }

  defaultDataModel(e) { const t = this._jsonModel.type || void 0; if (void 0 !== t) { return new J(e, t === 'array' ? [] : {}, t); } }
  ...
  reset() { if ((this.type === 'array' || G(this._jsonModel)) && this.items.length > this._jsonModel.initialItems) { const e = this.items.length - this._jsonModel.initialItems; for (let t = 0; t < e; t++) this.dispatch(new i()); } this.items.forEach(((e) => { e.reset(); })); }

  validate() { return this.items.flatMap(((e) => e.validate())).filter(((e) => e.fieldName !== '')); }

  dispatch(e) { super.dispatch(e); }

  importData(i) { if (void 0 !== this._data && this.type === 'array' && Array.isArray(i)) { const s = new J(this._data.$name, i, this._data.$type, this._data.parent); try { this._data.parent?.$addDataNode(s.$name, s, !0); } catch (e) { return void this.form.logger.error(`unable to setItems for ${this.qualifiedName} : ${e}`); } this._data = s; const r = this.syncDataAndFormModel(s); const a = this.items.length; r.added.forEach(((t) => { this.notifyDependents(e('items', t.getState(), null)), t.dispatch(new n()); })); for (let e = 0; e < a; e += 1) this._children[e].dispatch(new t()); r.removed.forEach(((t) => { this.notifyDependents(e('items', null, t.getState())); })); } }
  ...
  set activeChild(t) { if (t !== this._activeChild) { let n = this._activeChild; for (;n instanceof He;) { const e = n.activeChild; n.activeChild = null, n = e; } const i = e('activeChild', t, this._activeChild); this._activeChild = t, this.parent && t !== null && (this.parent.activeChild = this), this._jsonModel.activeChild = t?.id, this.notifyDependents(i); } }
  ...
  notifyChildren(t) { if (void 0 !== t.payload && void 0 !== t.payload.changes) for (const n of t.payload.changes) void 0 !== n.propertyName && Le.includes(n.propertyName) && this.items.forEach(((i) => { this.notifyDependents.call(i, e(n.propertyName, i.getState()[n.propertyName], null)), i.fieldType === 'panel' && this.notifyChildren.call(i, t); })); }
}N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], He.prototype, 'maxItems', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], He.prototype, 'minItems', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], He.prototype, 'activeChild', null); class Qe {
  _jsonModel;
  ...
  log(e, t) { this.logLevel !== 0 && this.logLevel <= Xe[t] && console[t](e); }

  logLevel;

  constructor(e = 'off') { this.logLevel = Xe[e]; }
} class Je {
  _node;
...
} const Ze = (e, t = null, n = {}) => { const i = { ...Ye, ...n }; const s = i.method === 'GET' && t ? et(e, t) : e; return i.method !== 'GET' && (i.body = t), fetch(s, { ...i }).then((async (t) => { let n; t.ok || console.error(`Error while fetching response from ${e} : ${t.statusText}`), n = t?.headers?.get('Content-Type')?.includes('application/json') ? await t.json() : await t.text(); const i = {}; return t?.headers?.forEach(((e, t) => { i[t] = e; })), { status: t.status, body: n, headers: i }; })); }; const Ye = { method: 'GET' }; const et = (e, t) => { if (!t) return e; let n = {}; try { n = JSON.parse(t); } catch (e) { console.log('Query params invalid'); } const i = []; return Object.keys(n).forEach(((e) => { Array.isArray(n[e]) ? i.push(`${encodeURIComponent(e)}=${encodeURIComponent(JSON.stringify(n[e]))}`) : i.push(`${encodeURIComponent(e)}=${encodeURIComponent(n[e])}`); })), i.length ? e.includes('?') ? `${e}&${i.join('&')}` : `${e}?${i.join('&')}` : e; }; const tt = (e) => { const t = e; return t.length > 0 && t.startsWith('custom:') ? t.substring(7) : t; }; const nt = async (e, t, n, i, s, r, a) => { const o = t; const l = { method: n }; let u; if (i && i instanceof de && i.data instanceof File) { const e = new FormData(); e.append(i.name, i.data), u = e; } else if (i instanceof FormData)u = i; else if (i && typeof i === 'object' && Object.keys(i).length > 0) { const e = Object.keys(a); e.length > 0 ? l.headers = { ...a, ...e.indexOf('Content-Type') === -1 ? { 'Content-Type': 'application/json' } : {} } : l.headers = { 'Content-Type': 'application/json' }; const t = l?.headers?.['Content-Type'] || 'application/json'; t === 'application/json' ? u = JSON.stringify(i) : t.indexOf('multipart/form-data') > -1 ? u = st(i) : t.indexOf('application/x-www-form-urlencoded') > -1 && (u = it(i)); } const m = await Ze(o, u, l); if (m?.status >= 200 && m?.status <= 299) { const t = tt(s); s === 'submitSuccess' ? e.form.dispatch(new d(m, !0)) : e.form.dispatch(new h(t, m, !0)); } else { e.form.logger.error('Error invoking a rest API'); const t = tt(r); r === 'submitError' ? (e.form.dispatch(new c(m, !0)), e.form.dispatch(new p(m, !0))) : e.form.dispatch(new h(t, m, !0)); } }; const it = (e) => { const t = new URLSearchParams(); return Object.entries(e).forEach((([e, n]) => { n != null && typeof n === 'object' ? t.append(e, Q(n)) : t.append(e, n); })), t; }; const st = (e, t) => { const n = new FormData(); Object.entries(e).forEach((([e, t]) => { t != null && typeof t === 'object' ? n.append(e, Q(t)) : n.append(e, t); })); const i = (e, t) => { if (e?.data instanceof File) { let n = `${e?.dataRef}/${e?.name}`; n.startsWith('/') || (n = `/${n}`), t.append(n, e.data); } }; return t && Object.keys(t).reduce(((e, s) => { const r = t[s]; return r && r instanceof Array ? [...e, ...r.map(((e) => i(e, n)))] : [...e, i(r, n)]; }), []), n; }; const rt = (e, t = {}, r = !1) => { switch (e) { case 'change': return new s(t); case 'submit': return new m(t); case 'save': return new f(t); case 'click': return new M(t); case 'addItem': return new v(t); case 'removeItem': return new i(t); case 'reset': return new g(t); case 'addInstance': return new y(t); case 'removeInstance': return new _(t); case 'invalid': return new u(t); case 'valid': return new l(t); case 'initialize': return new n(t); default: console.error('invalid action'); } }; class at {
      ...
      let n = t; typeof t === 'function' && (n = {
        _func: (e, n, i) => {
          const s = {
            ...
            functions: {
              setProperty: (e, t) => { const s = [e, 'custom:setProperty', t]; return at.getInstance().getFunctions().dispatchEvent._func.call(void 0, s, n, i); }, reset: (e) => { const t = [e = e || 'reset', 'reset']; return i.globals.form.logger.warn('This usage of reset is deprecated. Please see the documentation and update.'), at.getInstance().getFunctions().dispatchEvent._func.call(void 0, t, n, i); }, validate: (e) => { const t = [e]; return at.getInstance().getFunctions().validate._func.call(void 0, t, n, i); }, importData: (e, t) => { const s = [e, t]; return at.getInstance().getFunctions().importData._func.call(void 0, s, n, i); }, exportData: () => at.getInstance().getFunctions().exportData._func.call(void 0, e, n, i), submitForm: (e, t, s) => { const r = [e, t, s || 'multipart/form-data']; return at.getInstance().getFunctions().submitForm._func.call(void 0, r, n, i); }, markFieldAsInvalid: (e, t, n) => { !n || n.useId ? i.globals.form.getElement(e)?.markAsInvalid(t) : n && n.useDataRef ? i.globals.form.visit(((n) => { n.dataRef === e && n.markAsInvalid(t); })) : n && n.useQualifiedName && i.globals.form.resolveQualifiedName(e)?.markAsInvalid(t); }, setFocus: (e, t) => { const s = [e, t]; return at.getInstance().getFunctions().setFocus._func.call(void 0, s, n, i); }, dispatchEvent: (e, t, s, r) => { const a = [e, t, s, r]; return at.getInstance().getFunctions().dispatchEvent._func.call(void 0, a, n, i); }, getFiles: (e) => { const t = {}; e || i.globals.form.visit(((e) => { e.fieldType === 'file-input' && e.value && (t[e.qualifiedName] = e.serialize()); })); const n = i.globals.form.resolveQualifiedName(e); return n?.fieldType === 'file-input' && n?.value && (t[e] = n.serialize()), t; },
            },
          }; return t(...e, s);
        },
        _signature: [],
      }), n.hasOwnProperty('_func') ? at.getInstance().customFunctions[e] = n : console.warn(`Unable to register function with name ${e}.`);
    }));
  }

  unregisterFunctions(...e) { e.forEach(((e) => { e in at.getInstance().customFunctions && delete at?.getInstance().customFunctions[e]; })); }
  ...
  getFunctions() {
    function e(t) { return t == null ? t : (n = t) !== null && Object.prototype.toString.call(n) === '[object Array]' ? t.map(((t) => e(t))) : t.valueOf(); let n; } function t(e) { return e == null ? '' : e.toString(); } const n = {
      ...
      request: { _func: (n, i, s) => { const r = t(n[0]); const a = t(n[1]); const o = e(n[2]); let l; let u; let d = {}; return typeof n[3] === 'string' ? (s.globals.form.logger.warn('This usage of request is deprecated. Please see the documentation and update'), l = e(n[3]), u = e(n[4])) : (d = e(n[3]), l = e(n[4]), u = e(n[5])), nt(s.globals, r, a, o, l, u, d), {}; }, _signature: [] },
      ...
      addInstance: { _func: (t, n, i) => { const s = t[0]; const r = t.length > 2 ? e(t[2]) : void 0; try { const e = i.globals.form.getElement(s.$id); const t = rt('addInstance', r); e.addItem(t); } catch (e) { i.globals.form.logger.error('Invalid argument passed in addInstance. An element is expected'); } }, _signature: [] },
      removeInstance: { _func: (t, n, i) => { const s = t[0]; const r = t.length > 2 ? e(t[2]) : void 0; try { const e = i.globals.form.getElement(s.$id); const t = rt('removeInstance', r); e.removeItem(t); } catch (e) { i.globals.form.logger.error('Invalid argument passed in removeInstance. An element is expected'); } }, _signature: [] },
      dispatchEvent: { _func: (t, n, i) => { const s = t[0]; if (s === null && typeof i !== 'string') return i.debug.push('Invalid argument passed in dispatchEvent. An element is expected'), {}; let r; let a = e(t[1]); let o = t.length > 2 ? e(t[2]) : void 0; let l = t.length > 3 && e(t[3]); return typeof s === 'string' && (o = a, a = s, l = !0), r = a.startsWith('custom:') ? new h(a.substring(7), o, l) : rt(a, o, l), r != null && (typeof s === 'string' ? i.globals.form.dispatch(r) : i.globals.form.getElement(s.$id).dispatch(r)), {}; }, _signature: [] },
    }; return { ...n, ...at.getInstance().customFunctions };
  }
} const ot = at.getInstance(); class lt {
  #e;
  ...
  valueOf() { return this.toString(); }
} const ut = new lt('0.13'); const dt = new lt('0.13'); class ht extends He {
  _ruleEngine;
  ...
  constructor(e, i, a, o = new Ke(), l = 'off', u = 'create') { super(e, { fieldFactory: i, mode: u }), this._ruleEngine = a, this._eventQueue = o, this._logger = new We(l), this._applyDefaultsInModel(), u === 'create' && (this.queueEvent(new n()), this.changeEventBehaviour === 'deps' ? this.queueEvent(new s({ changes: [] })) : this.queueEvent(new t())), this._ids = (function* (e = 50) { const t = function () { const t = []; for (let n = 0; n < e; n++)t.push(pe(10)); return t; }; const n = {}; let i = t(); do { let e = i.pop(); for (;e in n;)i.length === 0 && (i = t()), e = i.pop(); n[e] = !0, yield i.pop(), i.length === 0 && (i = t()); } while (i.length > 0); }()), this.bindToDataModel(new J('$form', {})), this._initialize(u), u === 'create' && this.queueEvent(new r()); }

  _applyDefaultsInModel() { const e = this.specVersion; this._jsonModel.properties = this._jsonModel.properties || {}, this._jsonModel.fieldType = this._jsonModel.fieldType || 'form', (e.lessThan(dt) || typeof this._jsonModel.properties['fd:changeEventBehaviour'] !== 'string') && (this._jsonModel.properties['fd:changeEventBehaviour'] = 'self'); }
  ...
  get metaData() { const e = this._jsonModel.metadata || {}; return new Ge(e); }

  get action() { return this._jsonModel.action; }

  get isFragment() { return !1; }

  importData(e) { this.bindToDataModel(new J('$form', e)), this.syncDataAndFormModel(this.getDataNode()), this._eventQueue.runPendingQueue(); }

  exportData() { return this.getDataNode()?.$value; }

  setAdditionalSubmitMetadata(e) { this.additionalSubmitMetadata = { ...this.additionalSubmitMetadata, ...e }; }

  get specVersion() { if (typeof this._jsonModel.adaptiveform !== 'string') return ut; try { return new lt(this._jsonModel.adaptiveform); } catch (e) { return console.log(e), console.log(`Falling back to default version${ut.toString()}`), ut; } }

  resolveQualifiedName(e) { let t = null; return this.visit(((n) => { n.qualifiedName === e && (t = n); })), t; }

  exportSubmitMetaData() { const e = {}; this.visit(((t) => { t.fieldType === 'captcha' && (e[t.qualifiedName] = t.value); })); const t = { lang: this.lang, captchaInfo: e, ...this.additionalSubmitMetadata }; return new Be(t); }
  ...
  setFocus(e, t) { if (!t) return this.#o(e), void this.#a(e); const n = e?.isContainer ? e : e.parent; const i = this.#s(n.items); let s = n.activeChild; let r = s !== null ? i.indexOf(s) : -1; if (n.activeChild === null) return this.#a(i[0]), void (r = 0); t === A.NEXT_ITEM ? s = this.#l(r, i) : t === A.PREVIOUS_ITEM && (s = this.#u(r, i)), s !== null && this.#a(s); }

  getState(e = !1) { const t = this; const n = super.getState(!1, e); return n.id = '$form', Object.defineProperty(n, 'data', { get() { return t.exportData(); } }), Object.defineProperty(n, 'attachments', { get() { return me(t); } }), n; }
  ...
  submit(e, t) { const n = e?.payload?.validate_form; if (!n || this.validate().length === 0) { const n = e?.payload || {}; const i = n?.success ? n?.success : 'submitSuccess'; const s = n?.error ? n?.error : 'submitError'; const r = n.action || this.action; const a = n.metadata || { submitMetadata: this.exportSubmitMetaData() }; (async (e, t, n, i = 'multipart/form-data', s = null, r = '', a = null) => { const o = r || e.form.action; let l = s; typeof l === 'object' && l != null || (l = e.form.exportData()); const u = me(e.form, !0); let d = i; const h = { data: l, ...a }; let c = h; (Object.keys(u).length > 0 || i === 'multipart/form-data') && (c = st(h, u), d = 'multipart/form-data'), await nt(e, o, 'POST', c, t, n, { 'Content-Type': d }); })(t, i, s, n?.save_as || n?.submit_as, n?.data, r, a); } }

  save(e, t) { const n = e?.payload || {}; n.save_as = 'multipart/form-data', n.metadata = { draftMetadata: { lang: this.lang, draftId: this.properties?.draftId || '' } }, n.success = 'custom:saveSuccess', n.error = 'custom:saveError', this.submit(e, t), this.subscribe(((e) => { this._saveSuccess(e); }), 'saveSuccess'); }

  _saveSuccess(e) { const t = e?.payload?.body?.draftId || ''; const n = this.properties; t && n && (n.draftId = t); }
...
} function ct(e) { if (e == null) { const t = (new Intl.DateTimeFormat()).resolvedOptions(); e = t.locale; } return (t) => (function (e, t) { if (e === null) return 0; const n = +e; if (!isNaN(n)) return n; if (t) { const n = E(e, t, !0); if (n !== e) return x(n); } return 0; }(t, e)); } class pt {
  _context;
  ...
  constructor() { this.customFunctions = ot.getFunctions(); }

  compileRule(e, t) { const n = new b(this.customFunctions, ct(t), this.debugInfo); return { formula: n, ast: n.compile(e, this._globalNames) }; }
  ...
  trackDependency(e) { this._context && void 0 !== this._context.field && this._context.field !== e && e._addDependent(this._context.field); }
} class mt extends He {
...
}N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], ft.prototype, 'maxOccur', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], ft.prototype, 'minOccur', null); const gt = ['string', 'number', 'integer', 'boolean', 'file', 'string[]', 'number[]', 'integer[]', 'boolean[]', 'file[]', 'array', 'object']; class _t extends ze {
  ...
  _getFallbackType() {
    const e = this._jsonModel.type; let t = e; if (typeof e !== 'string' || gt.indexOf(e) === -1) {
  ...
  valueOf() { const e = this[ke]; const t = void 0 === e ? this : e; return t.ruleEngine.trackDependency(t), t._jsonModel.value || null; }

  toString() { const e = this[ke]; const t = void 0 === e ? this : e; return t._jsonModel.value?.toString() || ''; }

  getErrorMessage(e) { const t = e; const n = O[t]; const i = { ...S, ...C }; return this._jsonModel.constraintMessages?.[t === 'exclusiveMaximum' ? 'maximum' : t === 'exclusiveMinimum' ? 'minimum' : t] || ((e, t = []) => e?.replace(/\${(\d+)}/g, ((e, n) => { const i = t[n]; return void 0 !== i ? i : e; })))(i[n], [this._jsonModel[t]]); }
  ...
  _getConstraintObject() { return Oe; }
  ...
  getConstraints() { switch (this.type) { case 'string': switch (this.format) { case 'date': return Ne.date; case 'email': return Ne.email; case 'binary': case 'data-url': return Ne.file; default: return Ne.string; } case 'file': return Ne.file; case 'number': case 'integer': return Ne.number; } return this.isArrayType() ? Ne.array : []; }
  ...
  validate() { if (!1 === this.visible) return []; if (!1 === this.valid && this.errorMessage && this?.validity?.customConstraint) return [new R(this.id, [this._jsonModel.errorMessage])]; const e = this.evaluateConstraints(); return this.#d(), e.validity && this.notifyDependents(new s({ changes: Object.values(e) })), this.valid ? [] : [new R(this.id, [this._jsonModel.errorMessage])]; }

  syncDataAndFormModel(t) { if (void 0 !== t && t !== W && t.$value !== this._jsonModel.value) { const n = e('value', t.$value, this._jsonModel.value); this._jsonModel.value = t.$value, this.queueEvent(n); } }

  defaultDataModel(e) { const t = Fe.indexOf(this.fieldType) > -1 ? void 0 : this.getDataNodeValue(this._jsonModel.value); return new B(e, t, this.type || 'string'); }
  ...
  markAsInvalid(e, t = null) {
    const n = {
      valid: !1, errorMessage: e, validationMessage: e, validity: { valid: !1, ...t != null ? { [O[t]]: !0 } : { customConstraint: !0 } },
...
} function yt(e, t) { return e.replace(';base64', `;name=${encodeURIComponent(t)};base64`); } async function vt(e) {
  const { name: t, size: n, type: i } = e; return await new Promise(((s, r) => {
    const a = new FileReader(); a.onload = (e) => {
      s(new de({
        data: yt(e.target.result, t), type: i, name: t, size: n,
      }));
    }, a.readAsDataURL(e.data);
  }));
}N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }, qe('button', 'image', 'plain-text')], _t.prototype, 'readOnly', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }, qe('image', 'plain-text')], _t.prototype, 'enabled', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], _t.prototype, 'valid', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], _t.prototype, 'validity', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], _t.prototype, 'enum', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], _t.prototype, 'enumNames', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], _t.prototype, 'required', null), N([Ve('date-input', 'number-input')], _t.prototype, 'editValue', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], _t.prototype, 'value', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], _t.prototype, 'errorMessage', null), N([Ve('text-input', 'date-input', 'file-input', 'email')], _t.prototype, 'format', null), N([Ve('text-input')], _t.prototype, 'maxLength', null), N([Ve('text-input')], _t.prototype, 'minLength', null), N([Ve('text-input')], _t.prototype, 'pattern', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], _t.prototype, 'exclusiveMinimum', null), N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], _t.prototype, 'exclusiveMaximum', null); class Mt extends _t {
  ...
  get maxFileSize() { return fe(this._jsonModel.maxFileSize); }

  get accept() { return this._jsonModel.accept; }

  _applyUpdates(e, t) { return e.reduce(((e, n) => { const i = this._jsonModel[n]; const s = t[n]; return s !== i && (e[n] = { propertyName: n, currentValue: s, prevValue: i }, this._jsonModel[n] = i instanceof de && typeof s === 'object' && n === 'value' ? new de({ ...i, data: s.data }) : s), e; }), {}); }
  ...
  async serialize() { const e = this._jsonModel.value; if (void 0 === e) return null; let t; return await (t = e instanceof Array ? e : [e], Promise.all([].map.call(t, vt))); }

  syncDataAndFormModel(t) { if (void 0 !== t && t !== W) { const n = t?.$value; if (n != null) { const t = Oe.type(this.getInternalType(), n); t.valid || this.form.logger.debug(`unable to bind ${this.name} to data`), this.form.getEventQueue().queue(this, e('value', t.value, this._jsonModel.value)), this._jsonModel.value = t.value; } else this._jsonModel.value = null; } }
} class bt extends _t {
  offValue() { const e = this.enum; return e.length > 1 ? e[1] : null; }

  _getConstraintObject() { const e = { ...super._getConstraintObject() }; let t; return e.required = (t = this.offValue(), (e, n) => ({ valid: Oe.required(e, n).valid && (!e || n != t), value: n })), e; }
...
}N([function (e, t, n) { const i = n.get; i != null && (n.get = function () { return this.ruleEngine.trackDependency(this), i.call(this); }); }], bt.prototype, 'checked', null); class jt extends _t {
  ...
  _applyDefaults() { super._applyDefaults(), this.locale = (new Intl.DateTimeFormat()).resolvedOptions().locale, this._jsonModel.editFormat || (this._jsonModel.editFormat = 'short'), this._jsonModel.displayFormat || (this._jsonModel.displayFormat = this._jsonModel.editFormat), this._jsonModel.placeholder || (this._jsonModel.placeholder = I(this._jsonModel.editFormat, this.locale)); }

  get value() { return super.value; }

  set value(e) { if (typeof e === 'number') { const t = T(e); isNaN(t) || (super.value = w(t, this.locale, this._dataFormat)); } else if (this._jsonModel.editFormat !== 'short' && this._jsonModel.editFormat !== 'date|short') { const t = $(e, this.locale, this._jsonModel.editFormat) || $(e, this.locale, 'yyyy-MM-dd'); t instanceof Date ? super.value = w(t, this.locale, this._dataFormat) : super.value = e; } else super.value = e; }
} class xt extends _t {_getDefaults() { return { ...super._getDefaults(), format: 'email' }; }} class It extends _t {
  _captchaDisplayMode;
  ...
  constructor(e, t) { super(e, t), this._captchaDisplayMode = e.captchaDisplayMode, this._captchaProvider = e.captchaProvider, this._captchaSiteKey = e.siteKey; }
...
} class Tt extends _t {click() { if (!this._events?.click && this._jsonModel.buttonType) return this._jsonModel.buttonType === 'submit' ? this.form.dispatch(new m()) : this._jsonModel.buttonType === 'reset' ? this.form.dispatch(new g()) : void 0; }} const wt = {
  text: 'text-input', number: 'number-input', email: 'email', file: 'file-input', range: 'range', textarea: 'multiline-input',
}; const $t = new class {
  createField(e, t) {
    let n; const i = { ...t, fieldFactory: this }; if (e.fieldType = e.fieldType ? e.fieldType in wt ? wt[e.fieldType] : e.fieldType : 'text-input', G(e)) {
      const t = {
    ...
    } else 'items' in e || e.fieldType === 'panel' ? n = new mt(e, i) : L(e) || e.fieldType === 'file-input' ? n = new Mt(e, i) : (s = e, n = (s?.fieldType || z(s)) === 'checkbox' ? new bt(e, i) : (function (e) { return (e?.fieldType || z(e)) === 'checkbox-group'; }(e)) ? new jt(e, i) : (function (e) { const t = e?.fieldType || z(e); return t === 'text-input' && e?.format === 'email' || t === 'email'; }(e)) ? new xt(e, i) : (function (e) { const t = e?.fieldType || z(e); return t === 'text-input' && e?.format === 'date' || t === 'date-input'; }(e)) ? new Et(e, i) : (function (e) { return (e?.fieldType || z(e)) === 'captcha'; }(e)) ? new It(e, i) : (function (e) { return e?.fieldType === 'button'; }(e)) ? new Tt(e, i) : new _t(e, i)); let s; return n;
  }
}(); const
  Nt = (e, t, n = 'error', i = void 0) => { try { let s = i; s == null && (e = ve(e), s = new ht({ ...e }, $t, new pt(), new Ke(new We(n)), n)); const r = e?.data; return r && s.importData(r), typeof t === 'function' && t(s), s.getEventQueue().runPendingQueue(), s; } catch (e) { throw console.error(`Unable to create an instance of the Form ${e}`), new Error(e); } }; Nt.currentVersion = ut; const Dt = { logLevel: 'error' }; const Ot = (e, t = null, { logLevel: n } = Dt) => { try { const i = new ht({ ...e }, $t, new pt(), new Ke(new We(n)), n, 'restore'); return t && (i.bindToDataModel(new J('$form', t)), i.syncDataAndFormModel(i.getDataNode())), i.getEventQueue().empty(), i; } catch (e) { throw console.error(`Unable to restore an instance of the Form ${e}`), new Error(e); } }; const St = (e, t) => { try { const n = new ht({ ...e }, $t, new pt()); return t && n.importData(t), n.validate().length === 0; } catch (e) { throw new Error(e); } }; const Ct = (e, t) => { try { const n = new ht({ ...e }, $t, new pt()); t && n.importData(t); const i = n.validate(); return { messages: i, valid: i.length === 0 }; } catch (e) { throw new Error(e); } }; const Ft = (e, t = {}) => { const n = new Headers(); return Object.entries(t).forEach((([e, t]) => { n.append(e, t); })), new Promise(((n, i) => { Ze(`${e}.model.json`, null, { headers: t }).then(((e) => { if (e.status !== 200)i('Not Found'); else { let t = e.body; if ('model' in t) { const { model: e } = t; t = e; }n(Q(t)); } })); })); }; const At = (e) => { ot.registerFunctions(e); }; export {
  Nt as createFormInstance, Ft as fetchForm, At as registerFunctions, Ot as restoreFormInstance, Ct as validateFormData, St as validateFormInstance,
};
